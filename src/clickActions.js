...
function scrollToSection(id) {
  if (id == "pathplanner") { window.location.href = "http://voltranrobotics.tech/pathplanner"; }
  if (id == "scoutapp") { window.location.href = "http://voltranrobotics.tech/scoutapp"; }
  if (id == "sponsorship") {
